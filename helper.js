...
export function instantiateObject(url, scene, clickableGroups) {
    const clickableConfigs = [
        ...
        {"name":"Guest-book","cameraConfig":{"position":[-2.0946808357107156,1.8897503667066542,-1.2677464592320078],"rotation_deg":[-89.99999412518068,0.00005700275093128441,84.11575559649563],"fov":75,"zoom":1,"controls_target":[-2.0946809994592197,1.725160096356585,-1.2677464761082613],"controls_distance":0.16459027035015156}},
        ...
        {"name":"Resume","cameraConfig":{"position":[0.7564486587244148,0.750692189625982,1.522051979824044],"rotation_deg":[-90.00003084065828,0.000048305381176163596,122.55627000552902],"fov":75,"zoom":1,"controls_target":[0.7564479417833089,-0.099683038510391,1.5220524375563942],"controls_distance":0.8503752281367984}},
        ...
        {"name":"Date","cameraConfig":{"position":[-2.3643087294337564,1.6213622455562056,-1.6319600517946158],"rotation_deg":[-108.49140640035064,55.064544469001056,112.19252967892848],"fov":75,"zoom":1,"controls_target":[-3.415128985124802,0.9252297786593131,-1.3991534805213357],"controls_distance":1.2818044003928868}},
...
export function focusCamera(camera, controls, object, distance = 2) {
    ...
    // To place camera *behind* the object facing it, invert forward:
    const offset = forward.clone().multiplyScalar(-distance);

    const desiredPos = worldPos.clone().add(offset);

    // Now smoothly tween both camera position and controls target:
